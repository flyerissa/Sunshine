...
import static com.example.android.sunshine.data.WeatherContract.LocationEntry.CONTENT_URI;

/**
 * Created by silj on 15.06.2015.
 */
...
//        ContentValues testValues = TestUtilities.createNorthPoleLocationValues();
//        Uri locationUri = mContext.getContentResolver().insert(CONTENT_URI, testValues);
//        long locationRowId = ContentUris.parseId(locationUri);
//
//        // Verify we got a row back.
//        assertTrue(locationRowId != -1);
